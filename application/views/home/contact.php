						...
						<div class="col-lg-6">
							...
							<div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="200">
								...
								<ul class="list list-icons list-icons-style-2 mt-2">
									<li><i class="fas fa-map-marker-alt top-6"></i> <strong class="text-dark">Address : </strong> <?php echo $perusahaan['alamat_perusahaan']?></li>
									<li><i class="fas fa-phone top-6"></i> <strong class="text-dark">Phone:</strong> <?php echo $perusahaan['telepon']?></li>
									<li><i class="fas fa-envelope top-6"></i> <strong class="text-dark">Email:</strong> <a href="<?php echo $perusahaan['email']?>"><?php echo $perusahaan['email']?></a></li>
								</ul>
							</div>
							...
							<div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="200">
								...
								<ul class="list list-icons list-dark mt-2">
									<li><i class="far fa-clock top-6"></i> Senin - Jumat 08.00 sampai 21.00</li>
									<li><i class="far fa-clock top-6"></i> Sabtu 08.00 - 17.00</li>
									<li><i class="far fa-clock top-6"></i> Minggu - Tutup</li>
									<li><i class="far fa-clock top-6"></i> Tanggal Merah - Tutup</li>
								</ul>
							</div>
